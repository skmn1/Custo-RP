        ...
        {dayShifts.map(shift => (
          <div key={shift.id} className="relative group">
            ...
            <button
              ...
              className="absolute top-1 right-1 w-5 h-5 bg-white border border-gray-300 text-gray-600 rounded-full text-xs opacity-0 group-hover:opacity-100 transition-all duration-200 hover:border-red-400 hover:text-red-600 hover:bg-red-50 flex items-center justify-center shadow-sm hover:shadow-md"
              title="Delete shift"
            >
